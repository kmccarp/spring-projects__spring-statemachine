...
public class ReactiveLifecycleManagerTests {
	...
	public void testStartStop() {
		ReactiveLifecycleManager manager = new ReactiveLifecycleManager(reactor.core.publisher.Mono::empty, reactor.core.publisher.Mono::empty,
				reactor.core.publisher.Mono::empty, reactor.core.publisher.Mono::empty);
	...
	public void testStartRecursive() {
		...
		ReactiveLifecycleManager manager = new ReactiveLifecycleManager(startSupplier, reactor.core.publisher.Mono::empty,
				reactor.core.publisher.Mono::empty, reactor.core.publisher.Mono::empty);
	...
	public void testStartStops() {
		...
		ReactiveLifecycleManager manager = new ReactiveLifecycleManager(reactor.core.publisher.Mono::empty, reactor.core.publisher.Mono::empty,
				startSupplier, reactor.core.publisher.Mono::empty);
		startSupplier.setManager(manager);
		StepVerifier.create(manager.startReactively()).expectComplete().verify();
		assertThat(manager.isRunning()).isFalse();
		assertThat(manager.getLifecycleState()).isEqualTo(LifecycleState.STOPPED);
